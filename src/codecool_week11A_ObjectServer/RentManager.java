...
public class RentManager
{
	public static void main(String[] args)
	{
		...
		galaxyshooter.setId();
		List<Person> galaxyshooter_staff = new ArrayList<Person>();
		...
		tetris.setId();
		List<Person> tetris_staff = new ArrayList<Person>();
		...
		terminator.setId();
		List<Person> terminator_cast = new ArrayList<Person>();
		...
		godfather.setId();
		List<Person> godfather_cast = new ArrayList<Person>();
